...
comm_class[["cereals & cereal products"]] <- c("staple grain", "two-season rice", "one-season rice", "rice", "maize", "wheat", "sorghum", "millet", "grain", "coarse grains", "barley", "bread", "maize flour", "oats", "other cereals", "pasta", 
                                               ...
                                               "spring maize", "summer maize", "winter wheat", "flour", "genetically modified maize", "pancake", "pirogue", "pizza", "cake", "sweet bun", "tart")
comm_class[["fruits and derived products"]] <- c("processed fruit", "fruit juice", "dry fruit", "fresh fruit", "cherry", "perishable fruit", "durian", "fruit", "plantain", "avocado", "banana", "mango")
comm_class[["vegetables and derived products"]] <- c("vegetable juice", "processed vegetable", "fresh vegetable", "perishable vegetable", "vegetable", "onion", "tomato", "broccoli", "cabbage", "garlic")
comm_class[["sugar crops and sweeteners, and derived products"]] <- c("raw sugar", "sugar beet", "sugar", "sugarcane", "candy")
comm_class[["fibres of vegetal and animal origin"]] <- c("cotton", "plant-based fibers", "raw cotton")
comm_class[["compisite foods*"]] <- c("ready meals", "food products", "animal products", "other processed food", "food", "other food", "food at home", "food away from home", "processed food", "staple food",
                                          "healthy food", "unhealthy food", "food of plant origin", "own-produced food", "livestock products", "other animal products", "oil", "spring roll")
...
comm_class[["products from live animals"]] <- c("milk products", "fresh cream", "milk", "dairy", "egg", "dairy products", "milk fat", "non-fat milk solid", "raw milk", "yoghurt", "cheese")
...
comm_class[["products from slaughtered animals"]] <- c("seafood", "red meat", "cooked meat", "bovine meat", "poulty meat", "goat meat", "meat", "fish", "beef", "other meat", "cattle meat", "shrimp", "pork", "sheep meat")
comm_class[["livestock"]] <- c("pig", "lamb", "cattle", "goat", "poultry", "sheep", "livestock", "broiler chicken", "buffalo", "camel", "chicken", "cow", "other livestock", "oxen",
...
comm_class[["fodder crops and derived products"]] <- c("fodder", "animal feed", "feedgrain", "fodder crop", "fonio", "grass", "napier grass", "feed", "alfalfa")
comm_class[["nuts and derived products"]] <- c("cashews", "nuts")
comm_class[["beverage crops and spices"]] <- c("hop", "malt barley")
comm_class[["vegetable and animal oils and fats"]] <- c("butter", "margarine", "edible oil", "vegetable oil", "vegetable fat")
